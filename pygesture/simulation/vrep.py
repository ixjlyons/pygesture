...
try:
    ...
    print("No \"VREP\" environment variable.")
    sys.exit()
...
def simxGetObjectHandle(clientID, objectName, operationMode):
    ...
    '''
    handle = c_int()
    return c_GetObjectHandle(clientID, objectName.encode('utf-8'), byref(handle), operationMode), handle.value
...
def simxLoadModel(clientID, modelPathAndName, options, operationMode):
    ...
    '''
    baseHandle = c_int()
    return c_LoadModel(clientID, modelPathAndName.encode('utf-8'), options, byref(baseHandle), operationMode), baseHandle.value
...
def simxLoadUI(clientID, uiPathAndName, options, operationMode):
    ...
    ret = c_LoadUI(clientID, uiPathAndName.encode('utf-8'), options, byref(count), byref(uiHandles), operationMode)
...
def simxLoadScene(clientID, scenePathAndName, options, operationMode):
    ...
    return c_LoadScene(clientID, scenePathAndName.encode('utf-8'), options, operationMode)
...
def simxGetUIHandle(clientID, uiName, operationMode):
    ...
    handle = c_int()
    return c_GetUIHandle(clientID, uiName.encode('utf-8'), byref(handle), operationMode), handle.value
...
def simxAddStatusbarMessage(clientID, message, operationMode):
    ...
    return c_AddStatusbarMessage(clientID, message.encode('utf-8'), operationMode)
...
def simxAuxiliaryConsoleOpen(clientID, title, maxLines, mode, position, size, textColor, backgroundColor, operationMode):
    ...
    return c_AuxiliaryConsoleOpen(clientID, title.encode('utf-8'), maxLines, mode, c_position, c_size, c_textColor, c_backgroundColor, byref(consoleHandle), operationMode), consoleHandle.value
...
def simxAuxiliaryConsolePrint(clientID, consoleHandle, txt, operationMode):
    ...
    return c_AuxiliaryConsolePrint(clientID, consoleHandle, txt.encode('utf-8'), operationMode)
...
def simxSetUIButtonLabel(clientID, uiHandle, uiButtonID, upStateLabel, downStateLabel, operationMode):
    ...
    return c_SetUIButtonLabel(clientID, uiHandle, uiButtonID, upStateLabel.encode('utf-8'), downStateLabel.encode('utf-8'), operationMode)
...
def simxGetCollisionHandle(clientID, collisionObjectName, operationMode):
    ...
    handle = c_int()
    return c_GetCollisionHandle(clientID, collisionObjectName.encode('utf-8'), byref(handle), operationMode), handle.value
...
def simxGetDistanceHandle(clientID, distanceObjectName, operationMode):
    ...
    handle = c_int()
    return c_GetDistanceHandle(clientID, distanceObjectName.encode('utf-8'), byref(handle), operationMode), handle.value
...
def simxDisplayDialog(clientID, titleText, mainText, dialogType, initialText, titleColors, dialogColors, operationMode):
    ...
    c_uiHandle = c_int()
    return c_DisplayDialog(clientID, titleText.encode('utf-8'), mainText.encode('utf-8'), dialogType, initialText.encode('utf-8'), c_titleColors, c_dialogColors, byref(c_dialogHandle), byref(c_uiHandle), operationMode), c_dialogHandle.value, c_uiHandle.value
...
def simxClearFloatSignal(clientID, signalName, operationMode):
    ...
    return c_ClearFloatSignal(clientID, signalName.encode('utf-8'), operationMode)
...
def simxClearIntegerSignal(clientID, signalName, operationMode):
    ...
    return c_ClearIntegerSignal(clientID, signalName.encode('utf-8'), operationMode)
...
def simxClearStringSignal(clientID, signalName, operationMode):
    ...
    return c_ClearStringSignal(clientID, signalName.encode('utf-8'), operationMode)
...
def simxGetFloatSignal(clientID, signalName, operationMode):
    ...
    signalValue = c_float()
    return c_GetFloatSignal(clientID, signalName.encode('utf-8'), byref(signalValue), operationMode), signalValue.value
...
def simxGetIntegerSignal(clientID, signalName, operationMode):
    ...
    signalValue = c_int()
    return c_GetIntegerSignal(clientID, signalName.encode('utf-8'), byref(signalValue), operationMode), signalValue.value
...
def simxGetStringSignal(clientID, signalName, operationMode):
    ...
    ret = c_GetStringSignal(clientID, signalName.encode('utf-8'), byref(signalValue), byref(signalLength), operationMode)
...
def simxGetAndClearStringSignal(clientID, signalName, operationMode):
    ...
    signalLength = c_int();
    signalValue = pointer(c_ubyte())
    ret = c_GetAndClearStringSignal(clientID, signalName.encode('utf-8'), byref(signalValue), byref(signalLength), operationMode)
...
def simxReadStringStream(clientID, signalName, operationMode):
    ...
    signalLength = c_int();
    signalValue = pointer(c_ubyte())
    ret = c_ReadStringStream(clientID, signalName.encode('utf-8'), byref(signalValue), byref(signalLength), operationMode)
...
def simxSetFloatSignal(clientID, signalName, signalValue, operationMode):
    ...
    return c_SetFloatSignal(clientID, signalName.encode('utf-8'), signalValue, operationMode)
...
def simxSetIntegerSignal(clientID, signalName, signalValue, operationMode):
    ...
    return c_SetIntegerSignal(clientID, signalName.encode('utf-8'), signalValue, operationMode)
...
def simxAppendStringSignal(clientID, signalName, signalValue, operationMode):
    ...
    return c_AppendStringSignal(clientID, signalName.encode('utf-8'), signalValue, len(signalValue), operationMode)
...
def simxWriteStringStream(clientID, signalName, signalValue, operationMode):
    ...
    return c_WriteStringStream(clientID, signalName.encode('utf-8'), signalValue, len(signalValue), operationMode)
...
def simxStart(connectionAddress, connectionPort, waitUntilConnected, doNotReconnectOnceDisconnected, timeOutInMs, commThreadCycleInMs):
    ...
    Please have a look at the function description/documentation in the V-REP user manual
    '''
    return c_Start(connectionAddress.encode('utf-8'), connectionPort, waitUntilConnected, doNotReconnectOnceDisconnected, timeOutInMs, commThreadCycleInMs)
...
def simxTransferFile(clientID, filePathAndName, fileName_serverSide, timeOut, operationMode):
    ...
    return c_TransferFile(clientID, filePathAndName.encode('utf-8'), fileName_serverSide.encode('utf-8'), timeOut, operationMode)
...
def simxEraseFile(clientID, fileName_serverSide, operationMode):
    ...
    return c_EraseFile(clientID, fileName_serverSide.encode('utf-8'), operationMode)
...
def simxGetObjectGroupData(clientID, objectType, dataType, operationMode):
    ...
    if ret == 0:
        ...
        for i in range(stringDataC.value):
            a = ""
            b = bytearray(stringDataP[s])
            while chr(bytearray(stringDataP[s])[0]) != '\0':
                a += chr(bytearray(stringDataP[s])[0])
                s += 1
            s += 1 #skip null
            stringData.append(a)
