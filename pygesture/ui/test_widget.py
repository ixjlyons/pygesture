...
class Ui_TestWidget(object):
    def setupUi(self, TestWidget):
        ...
        self.gridLayout_4.addWidget(self.trainButton, 3, 0, 1, 1)
    ...
    def retranslateUi(self, TestWidget):
        ...
        self.sessionInfoBox.setTitle(_translate("TestWidget", "Session Info", None))
        self.trainingLabel.setText(_translate("TestWidget", "Training Data:", None))
        self.pidLabel.setText(_translate("TestWidget", "Participant ID:", None))
