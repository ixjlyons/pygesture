...
class Ui_TrainWidget(object):
    def setupUi(self, TrainWidget):
        ...
        self.gestureView.setAlignment(QtCore.Qt.AlignCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.promptWidget.sizePolicy().hasHeightForWidth())
        self.promptWidget.setSizePolicy(sizePolicy)
